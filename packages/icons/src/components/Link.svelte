...
>
  ...
  {:else}
    ...
    <path d="M0 0h24v24H0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m11.293 7.05 2.121-2.121a4 4 0 0 1 5.657 5.657l-2.828 2.828a4 4 0 0 1-5.657 0M12 17.657l-1.414 1.414a4 4 0 1 1-5.657-5.657l2.121-2.121a4 4 0 0 1 5.657 0"/>
  {/if}
</svg>

...
>
  ...
  {:else}
    ...
    <path d="M0 0h24v24H0z"/><path d="m19.315 6.402-.658.754zm-3.333-2.909-.658.754zM20 9a1 1 0 1 0 0-2zm-5 10.6a1 1 0 1 0-2 0zM5.667 8a1 1 0 0 0 0-2zM9 5H8v10h2V5zm2 12v1h7v-2h-7zm9-2h1V7.91h-2V15zm-.685-8.598.658-.753-3.334-2.91-.657.754-.658.754 3.333 2.909zM14.667 3V2H11v2h3.667zm1.315.493.657-.753A3 3 0 0 0 14.667 2v2a1 1 0 0 1 .657.247zM20 7.91h1a3 3 0 0 0-1.027-2.26l-.658.753-.658.754A1 1 0 0 1 19 7.91zM18 17v1a3 3 0 0 0 3-3h-2a1 1 0 0 1-1 1zm-9-2H8a3 3 0 0 0 3 3v-2a1 1 0 0 1-1-1zM9 5h1a1 1 0 0 1 1-1V2a3 3 0 0 0-3 3zm6-2h-1v4.5h2V3zm.5 5v1H20V7h-4.5zm-.5-.5h-1A1.5 1.5 0 0 0 15.5 9V7a.5.5 0 0 1 .5.5zM4 8.667H3V19h2V8.667zM6 21v1h6.6v-2H6zm6.6 0v1a2.4 2.4 0 0 0 2.4-2.4h-2a.4.4 0 0 1-.4.4zM4 19H3a3 3 0 0 0 3 3v-2a1 1 0 0 1-1-1zM5.667 7V6A2.667 2.667 0 0 0 3 8.667h2C5 8.298 5.298 8 5.667 8z"/>
  {/if}
</svg>

...
>
  ...
  {:else}
    ...
    <path d="M0 0h24v24H0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13c0 6.5-9 13.5-18 3m0 0v5m0-5h5m-5-5c0-6.5 9-13.416 18-2.916m0 0v-5m0 5h-5"/>
  {/if}
</svg>

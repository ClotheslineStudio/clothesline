...
>
  ...
  {:else}
    <g fill="none" stroke={primaryColor} stroke-width={resolvedStroke}>
      <path d="M3 14v-4a1 1 0 0 1 1-1h4.638a1 1 0 0 0 .64-.232l4.082-3.401a1 1 0 0 1 1.64.768v11.73a1 1 0 0 1-1.64.768l-4.082-3.401a1 1 0 0 0-.64-.232H4a1 1 0 0 1-1-1Z"/><path d="M18 9a4.243 4.243 0 0 1 0 6"/>
    </g>
  {/if}
</svg>

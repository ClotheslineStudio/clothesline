...
>
  ...
  {:else}
    <g fill="none" stroke={primaryColor} stroke-width={resolvedStroke}>
      <rect width="18" height="7" x="3" y="14" rx="2"/><rect width="18" height="7" x="3" y="3" rx="2"/><circle cx="7.5" cy="17.5" r=".5"/><circle cx="7.5" cy="6.5" r=".5"/><circle cx="11.5" cy="17.5" r=".5"/><circle cx="11.5" cy="6.5" r=".5"/>
    </g>
  {/if}
</svg>

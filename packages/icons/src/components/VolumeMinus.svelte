...
>
  ...
  {:else}
    <g fill="none" stroke={primaryColor} stroke-width={resolvedStroke}>
      <path d="M3 14.5v-5a.5.5 0 0 1 .5-.5h4.807a.5.5 0 0 0 .336-.13l4.52-4.11a.5.5 0 0 1 .837.37v13.74a.5.5 0 0 1-.836.37l-4.521-4.11a.5.5 0 0 0-.336-.13H3.5a.5.5 0 0 1-.5-.5Z"/><path d="M17 12h4"/>
    </g>
  {/if}
</svg>

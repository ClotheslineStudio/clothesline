...
>
  ...
  {:else}
    <g fill="none" stroke={primaryColor} stroke-width={resolvedStroke}>
      <circle cx="12" cy="12" r="9"/><path d="M9 10.286A2.286 2.286 0 0 1 11.286 8h1.428A2.286 2.286 0 0 1 15 10.286v.857a2 2 0 0 1-2 2h-1.143A.857.857 0 0 0 11 14"/><circle cx="11" cy="17" r=".5"/>
    </g>
  {/if}
</svg>

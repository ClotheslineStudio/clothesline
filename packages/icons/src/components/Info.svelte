...
{:else if variant === 'duotone' && false}
  ...
  {:else}
    ...
    <g stroke="currentColor" stroke-width={effectiveStrokeWidth}>
      <path d="M10 8a1 1 0 0 1 1 1v6.299a1 1 0 0 1-2 0V9a1 1 0 0 1 1-1"/><path d="M10 5a1 1 0 1 1 0 2 1 1 0 0 1 0-2"/><path fill-rule="evenodd" d="M10 0c5.523 0 10 4.477 10 10s-4.477 10-10 10S0 15.523 0 10 4.477 0 10 0m0 2a8 8 0 1 0 0 16 8 8 0 0 0 0-16" clip-rule="evenodd"/>
    </g>
  {/if}
</svg>

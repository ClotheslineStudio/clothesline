...
export const switchTokens = {
  /* Track */
  'switch-track-bg': 'var(--color-surface-400-vis)',
  'switch-track-bg-hover': 'var(--color-surface-500-vis)',
  'switch-track-bg-active': 'var(--color-primary-500-vis)',
  'switch-track-bg-checked-hover': 'var(--color-primary-600-vis)',  // NEW
  ...
  'switch-thumb-bg-active': 'var(--on-primary)',
  'switch-thumb-bg-disabled': 'var(--color-surface-200)',

  /* Depth (no borders) */
  'switch-thumb-shadow': '0 1.5px 3px rgba(0,0,0,0.25)',
  'switch-thumb-shadow-active': '0 2px 6px rgba(0,0,0,0.28)',       // NEW

...
>
  ...
  {:else}
    <g fill="none" stroke={primaryColor} stroke-width={resolvedStroke}>
      <path d="m17 17-6.286-6.286L7 7"/><path d="m12.5 18.5-4.786-4.786L4 10"/><path d="M12 5C6 5 2 10 2 12s4 7 10 7 10-5 10-7-4-7-10-7Z"/><path d="M15.262 14.111A3 3 0 0 0 11 9.888"/>
    </g>
  {/if}
</svg>

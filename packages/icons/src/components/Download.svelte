...
>
  ...
  {:else}
    ...
    <path d="M0 0h24v24H0z"/><path stroke-linecap="round" stroke-width="2" d="M5 15v2a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-2M9 12l2.646 2.646a.5.5 0 0 0 .708 0L15 12m-3 1V5"/>
  {/if}
</svg>

...
>
  ...
  {:else}
    <g fill="none" stroke={primaryColor} stroke-width={resolvedStroke}>
      <path d="M6 7h2m0 2h2M8 5v9m-2-3h2m0 1.5h2"/><path d="M13 19h6a2 2 0 0 0 2-2v-6.833a2 2 0 0 0-2-2h-5a2 2 0 0 1-2-2V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v12.167"/><path d="M10 18v-1a2 2 0 1 0-4 0v1a2 2 0 1 0 4 0Z"/>
    </g>
  {/if}
</svg>

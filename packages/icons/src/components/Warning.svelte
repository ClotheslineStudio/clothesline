...
>
  ...
  {:else}
    <g fill="none" stroke={primaryColor} stroke-width={resolvedStroke}>
      <path d="m21.774 15.847-8.14-11.532a2 2 0 0 0-3.268 0l-8.14 11.532C1.29 17.172 2.238 19 3.86 19h16.28c1.622 0 2.57-1.828 1.634-3.153Z"/><path d="M12 8v4"/><circle cx="12" cy="15" r=".5"/>
    </g>
  {/if}
</svg>
